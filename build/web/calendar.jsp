...
<html lang="en">
    <head>
        ...
        <!-- ionicons -->
        <link href="twitterBootstrap/css/ionicons.min.css" rel="stylesheet">7

        <!-- Animate -->

        <!--FullCalendar Dependencies-->
        <link href='twitterBootstrap/css/fullcalendar.css' rel='stylesheet' />
        <link href='twitterBootstrap/css/fullcalendar.print.css' rel='stylesheet' media='print' />

        <!--jQuery-->
        <script src='twitterBootstrap/js/jquery.min.js'></script>
        <script src='twitterBootstrap/js/jquery-ui.min.js'></script>
        <script src='twitterBootstrap/js/moment.min.js'></script>
        ...
        <!--FullCalendar-->
        <script src='twitterBootstrap/js/fullcalendar.min.js'></script>
    ...
    <body class="overflow-hidden">
        ...
        <!-- Jauery UI -->
        <script src="twitterBootstrap/js/jquery-ui.custom.min.js"></script>   
